...
<div class="card">
    <div class="title">
      ...
      <button class="collapse-btn" @click="isExpanded = !isExpanded">
        <svg v-if="isExpanded" width="16" height="16" viewBox="0 0 24 24">
        <path fill="#000000" d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/>
        </svg>
        <svg v-else width="16" height="16" viewBox="0 0 24 24">
        <path fill="#000000" d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"/>
        </svg>
      </button>
    </div>
    <div class="comments">
      ...
      <div class="comment-container">
        <div class="user">
          ...
          <div class="user-info">
            <span>NWPU-114514</span>
            <p>109.4469804° E, 34.4120248° N, 周二, 4月15日, 20:06 (东8区)</p>
          </div>
        </div>
        <p class="comment-content">
          你好，这是测试聊天用例，你好，这是测试聊天用例
        </p>
      </div>
    </div>
  
    <div class="text-box" v-if="isExpanded">
      <div class="box-container">
        <textarea placeholder="输入内容以回复"></textarea>
        <div>
...
.comments {
  display: grid;
  grid-template-columns: 1fr; /* 从 35px 1fr 修改为单列 */
  gap: 20px;
  padding: 20px;
}
/*
